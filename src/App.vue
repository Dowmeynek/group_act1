...
@import '@/assets/assets/css/templatemo-digimedia-v3.css';
@import '@/assets/assets/bootstrap/bootstrap.min.css';
</style>
...
<html lang="en">
  ...
  <head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="assets/assets/css/bootstrap.min.css" type="text/css">


    <!-- Additional CSS Files -->
    <link type="text/css" href="assets/assets/css/fontawesome.css">
    <link type="text/css" href="assets/assets/css/templatemo-digimedia-v3.css">
    <link type="text/css" href="assets/assets/css/animated.css">
    <link type="text/css" href="assets/assets/css/owl.css">
<!--
